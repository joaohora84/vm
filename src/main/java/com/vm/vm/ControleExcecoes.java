...
public class ControleExcecoes extends ResponseEntityExceptionHandler{
	...
	protected ResponseEntity<Object> handleExceptionDataIntegry(Exception ex) {
		...
		ObjetoErro objetctError = new ObjetoErro();
		objetctError.setError(msg);
		objetctError.setCode(
				HttpStatus.INTERNAL_SERVER_ERROR + " ==> " + HttpStatus.INTERNAL_SERVER_ERROR.getReasonPhrase());

		return new ResponseEntity<>(objetctError, HttpStatus.INTERNAL_SERVER_ERROR);
